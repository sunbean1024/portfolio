...
export const projects: Project[] = [
  ...
  },
  {
    ...
    "imageUrl": "",
    "reflection": [
      "실시간 데이터 처리와 다양한 디바이스 환경 대응이 중요한 시스템에서, WebRTC와 Socket.io의 활용도가 높다는 것을 실감했습니다. 특히 실시간 채팅 시스템에서 메시지 순서 보장과 중복 처리 방지, 그리고 연결 끊김 시 자동 재연결 로직 구현 과정에서 실시간 데이터 스트림을 효율적으로 처리하는 구체적인 패턴들을 익힐 수 있었습니다.",
